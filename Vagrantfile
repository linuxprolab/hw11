...
Vagrant.configure("2") do |config|
  ...
  config.vm.define "box1" do |box1|
    #box1.vm.network "private_network", ip: "192.168.77.201"
    ...
    #box1.ssh.host = "192.168.77.201"
  end
  config.vm.define "box2" do |box2|
    #box2.vm.network "private_network", ip: "192.168.77.202"
    ...
    #box2.ssh.host = "192.168.77.202"
    # box2.vm.provision "ansible" do |ansible|
    #   ansible.inventory_path = "all.yml"
    #   ansible.limit = "all"
